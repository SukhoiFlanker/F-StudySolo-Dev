...
| **Glassmorphism / Glow** | BANNED. Used to be our old style | WE NOW USE **INK & PARCHMENT** (Solid Ivory + Sharp Shadows) |
| **Deep Cyan / Fintech Blue** | Safe harbor from purple ban | Why not Red, Black, or Oxford Blue? |
| **"Orchestrate / Empower"** | AI-generated copywriting | How would a human say this? |
| Dark background + neon glow | BANNED. The old "AI look" | WE NOW USE **LIGHT MODE CHRONICLES** (Ivory Paper) |
| **Rounded everything** | Generic/Safe | WE NOW USE **SHARP 0px BRUTALIST EDGES** |
...
### The "Ink & Parchment" Core System (StudySolo Standard)

```
Key properties:
├── NO Glassmorphism. NO Glow.
├── Hard, solid colors (Ivory Paper backgrounds: #F9F9F6)
├── Sharp 0px corners strictly enforced
└── ⚠️ **WARNING:** Standard blue/white glassmorphism is BANNED. We use solid, academic paper vibes.
```
