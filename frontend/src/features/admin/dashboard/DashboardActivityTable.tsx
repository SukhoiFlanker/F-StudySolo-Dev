...
const HEADERS = ['记录 ID', '操作人', '操作类型', '目标资源', '时间'];
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody>
              {logs.logs.map((log) => (
                <tr key={log.id} className="border-b border-[#ddd8cf] transition-colors last:border-b-0 hover:bg-[#ebe9df]">
                  ...
                  <td className="px-5 py-4">
                    <StatusBadge label={log.action} className="border-[#c4c6cf] bg-[#f4f4f0] text-[#002045]" />
                  </td>
